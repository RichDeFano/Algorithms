	...
	public static void question0() {
        ...
        ////////////////////////AVL TREE       
            ...
            //Insert all N keys
                ...
                {
                    //System.out.println("Key = " + keys[q]);
                    avl.insert(keys[q]);
                }
            //Sort them using inorder(int i, int[] res)
                treeNode root = avl.getRoot();
                int finishAt = root.inOrder(0, res);
                //System.out.println("Next open position at " + finishAt);
         ...
         ////////////////////////Red-Black TREE 
            ...
            //Sort them using inorder(int i, int[] res)
                treeNode rootrb = rbt.getRoot();
                int finishAtrb = rootrb.inOrder(0, res);
                //System.out.println("Next open position at " + finishAt);
            //Collect running times
                finish = System.currentTimeMillis();
                times[1] = (finish-start);
                System.out.println("RBT search tree: " + (finish-start) + " milliseconds.");
            //Clear the tree
                rbt.clear();
